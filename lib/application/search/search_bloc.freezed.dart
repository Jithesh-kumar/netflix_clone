...
/// @nodoc
mixin _$SearchState {
  List<SearchResultData> get searchResultsList =>
      throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<SearchResultData> searchResultsList,
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl(
      {required final List<SearchResultData> searchResultsList,
  ...
  final List<SearchResultData> _searchResultsList;
  @override
  List<SearchResultData> get searchResultsList {
  ...
  @override
  String toString() {
    return 'SearchState(searchResultsList: $searchResultsList, idleList: $idleList, isLoading: $isLoading, isError: $isError)';
  }
